/*
 * Copyright (C) 2014, Roberto J. Kondurura, Samuel I. Gunadi.
 */
        ...
        implements ActionListener, FocusListener
{
    ...
    public Clock()
    {
        ...
        display.setText("<html><span style=\"font-size: 36px;\"> "
                + hour + " : " + min + " : " + sec
                + " ".concat(am_pm == 0 ? "AM" : "PM") + "</span></html>");
        Timer t = new Timer(1000,
                new ActionListener()
                {
                    ...
                    public void actionPerformed(ActionEvent e)
                    {
                        ...
                        int sec = now.get(Calendar.SECOND);
                        int am_pm = now.get(Calendar.AM_PM);
                        //display = new JLabel(hour + " : " + min + " : "
                        // + sec, SwingConstants.CENTER);
                        display.setText("<html><span style=\"font-size: 36px;\"> "
                                + hour + " : " + min + " : " + sec
                                + " ".concat(am_pm == 0 ? "AM" : "PM")
                                + "</span></html>");
    ...
    public class StopwatchHandler implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (e.getSource() == get)
            {
                ...
                elapsedTime.setText("<html><span style=\"font-size: 18px\">"
                        + msc / 3600000 + " : " + (msc % 3600000) / 60000
                        + " : " + msc / 1000 % 60 + " . " + msc % 1000
                        + "</span></html>");
                if (sum != 1)
                {
                    add(elapsedTime);
